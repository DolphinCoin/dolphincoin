#############################################################################
# Makefile for building: dolphincoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ??? ?? 29 22:01:33 2014
# Project:  dolphincoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe -o Makefile dolphincoin-qt.pro
#############################################################################
...
Makefile: dolphincoin-qt.pro  c:/Qt/4.8.5/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile dolphincoin-qt.pro
