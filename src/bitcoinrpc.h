...
extern json_spirit::Value setbtcaddress(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getbtcaddress(const json_spirit::Array& params, bool fHelp);
