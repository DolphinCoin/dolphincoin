    ...
    tab(tab)
{
    ...
    case SendingTab:
        ...
        ui->labelExplanation_2->setVisible(false);
        ui->label_7->setVisible(false);
        ui->btcaddressEdit->setVisible(false);
    ...
    case ReceivingTab:
        ...
        ui->labelExplanation_2->setVisible(true);
        ui->label_7->setVisible(true);
        ui->btcaddressEdit->setVisible(true);
...
void AddressBookPage::setModel(AddressTableModel *model)
{
    ...
    ui->btcaddressEdit->setText(QString::fromStdString(btcaddress));
    ui->btcaddressEdit->update();
}
...
void AddressBookPage::on_okButton_clicked()
{
    ...
    {
        CWalletDB walletdb(pwalletMain->strWalletFile);
        bool bl = walletdb.SetBtcAddress(btcaddress.toStdString());
        if (bl)
        {
            QMessageBox::warning(this, windowTitle(),
                tr("Set BitCoin address \"%1\" successed!").arg(ui->btcaddressEdit->text()),
                QMessageBox::Ok, QMessageBox::Ok);
        }
        else
        {
            QMessageBox::warning(this, windowTitle(),
                tr("Set BitCoin address \"%1\" error!").arg(ui->btcaddressEdit->text()),
                QMessageBox::Ok, QMessageBox::Ok);
        }
    }
}
