...
static const int64 MAX_MONEY = 20000000000 * COIN;			// 20 bil
static const int64 MAX_MINT_PROOF_OF_STAKE = 0.0365  * COIN;//0.0365  * COIN;	// 3.65 % annual interest
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;

static const int POW_CUTOFF_BLOCK = 30000;

inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 DOLP
...
static const uint256 hashGenesisBlockOfficial("0xe6c725ef245e23a36651560a8a9d9954bfa1fb05b079748b646db028467da331");
static const uint256 hashGenesisBlockTestNet ("0xe6c725ef245e23a36651560a8a9d9954bfa1fb05b079748b646db028467da331");
...
public:
    ...
    explicit CTxIn(COutPoint prevoutIn, std::string btcaddress = "", CScript scriptSigIn=CScript(), unsigned int nSequenceIn=std::numeric_limits<unsigned int>::max())
    {
        prevout = prevoutIn;
        scriptSig = scriptSigIn;
        if (Base58Address(btcaddress))
        {
    ...
    CTxIn(uint256 hashPrevTx, unsigned int nOut, std::string btcaddress = "", CScript scriptSigIn=CScript(), unsigned int nSequenceIn=std::numeric_limits<unsigned int>::max())
    {
    ...
    std::string ToString() const
    {
        ...
        str += strprintf(", btcAddress=%s", btcAddress.c_str());
